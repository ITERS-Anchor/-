<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="WebApplication.WebDemos.NewsList" %>
            ...
            <div class="cont">
            	<ul class="list_news">
                    <% foreach (UserInfo u in UserList){%>
                        ...
                        <li><span><%=u.UserId%></span><a href="Shownews.html" target="_blank"><%=u.UserName%></a></li>
